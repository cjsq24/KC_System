...
function fAjax(Operacion)
{
	...
	$.ajax(
	{
	  cache: false, type: 'POST', dataType: 'json', url:'../Controladores/Lista.con.php',
...
function fTablaAjax()
{
	...
	xmlhttp.open('POST','../Modelos/Scripts/Lista.ajax.php',true);
