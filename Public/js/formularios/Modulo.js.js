...
{
	$('#txtIdModulo').val(Datos.idmodulo);
...
function fAjax(Operacion)
{
	...
	$.ajax(
	{
	  cache: false, type: 'POST', dataType: 'json', url:'../Controladores/Modulo.con.php',
...
$('#Form').on('success.form.fv', function(e)
{
	...
	{
		swal('Alerta','Debe seleccionar un icono para el modulo','info');
	}
...
{
	$('#spanIcono').css('background','white');
	$('#btnListIcono').removeAttr('disabled');
}
function fConsultaExtra()
{
	$('#spanIcono').css('background','#EBEBEB');
...
function fTablaAjax()
{
	...
	xmlhttp.open('POST','../Modelos/Scripts/Modulo.ajax.php',true);
