...
{
	$('#txtIdModeloBalanza').val(Datos.idmodelobalanza);
...
function fAjax(Operacion)
{
	...
	$.ajax(
	{
	  cache: false, type: 'POST', dataType: 'json', url:'../Controladores/ModeloBalanza.con.php',
...
function fTablaAjax()
{
	...
	xmlhttp.open('POST','../Modelos/Scripts/ModeloBalanza.ajax.php',true);
