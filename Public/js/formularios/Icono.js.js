...
function fLlenarCampos(Datos)
{
	...
	document.getElementById('spanIcono').className = 'input-group-addon spanIcono ' + $('#txtNombre').val();
...
function fAjax(Operacion)
{
	...
	$.ajax(
	{
	  cache: false, type: 'POST', dataType: 'json', url:'../Controladores/Icono.con.php',
...
function fTablaAjax()
{
	...
	xmlhttp.open('POST','../Modelos/Scripts/Icono.ajax.php',true);
